...
Den bygningsansvarlige skal udlevere plantegning over bygningen inden bygningsgennemgangen kan foretages.</footer>
    ...
    <script type="text/javascript">
        ...
        if (buildingName = getCookie("buildingName"))
            document.form3.buildingName.value = buildingName;
        if (dato = getCookie("dato"))
            document.form3.dato.value = dato;
        if (address = getCookie("address"))
            document.form3.address.value = address;
        if (Zip = getCookie("Zip"))
            document.form3.Zip.value = Zip;
        if (byggeår = getCookie("byggeår"))
            document.form3.byggeår.value = byggeår;
        if (size = getCookie("size"))
            document.form3.size.value = size;
        if (bygningBrugesTil = getCookie("bygningBrugesTil"))
            document.form3.bygningBrugesTil.value = bygningBrugesTil;
        if (tagBemærkningCheck = getCookie("tagBemærkningCheck"))
            document.form3.tagBemærkningCheck.value = tagBemærkningCheck;
        if (roofPictureCheck = getCookie("roofPictureCheck"))
            document.form3.roofPictureCheck.value = roofPictureCheck;
        if (roofPicture = getCookie("roofPicture"))
            document.form3.roofPicture.value = roofPicture;
        if (textTagBemærkning = getCookie("textTagBemærkning"))
            document.form3.textTagBemærkning.value = textTagBemærkning;
        if (vægBemærkningCheck = getCookie("vægBemærkningCheck"))
            document.form3.vægBemærkningCheck.value = vægBemærkningCheck;
        if (wallPicture = getCookie("wallPicture"))
            document.form3.wallPicture.value = wallPicture;
        if (textGenForetagetAf = getCookie("textGenForetagetAf"))
            document.form3.textGenForetagetAf.value = textGenForetagetAf;
        if (textSamarbejdeMed = getCookie("textSamarbejdeMed"))
            document.form3.textSamarbejdeMed.value = textSamarbejdeMed;
        if (tilstand = getCookie("tilstand"))
            document.form3.tilstand.value = tilstand;
